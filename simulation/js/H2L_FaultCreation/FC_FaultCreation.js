...
//									 console.log(ExpTrackData);
									 ...
									 if(FC_3FaultDetectionCnt == 3){
										 ...
										 $('#mainDiv').html('');
											$('#mainDiv').html('<div class="col-md-offset-3 col-md-6 col-md-offset-3"><div class="alert alert-success" style="margin-top:150px; font-size:18px; font-weight:bold;">Congratulations!!! I/P Converter experiment is completed successfully!!</div></div>');
